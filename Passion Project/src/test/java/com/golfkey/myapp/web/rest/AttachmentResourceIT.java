...
import static com.golfkey.myapp.web.rest.TestUtil.sameInstant;
...
import com.golfkey.myapp.domain.Attachment;
import com.golfkey.myapp.repository.AttachmentRepository;
...
class AttachmentResourceIT {
    ...
    void putNewAttachment() throws Exception {
        ...
        updatedAttachment.name(UPDATED_NAME).date(UPDATED_DATE).file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
    ...
    void partialUpdateAttachmentWithPatch() throws Exception {
        ...
        partialUpdatedAttachment.date(UPDATED_DATE);
    ...
    void fullUpdateAttachmentWithPatch() throws Exception {
        ...
        partialUpdatedAttachment.name(UPDATED_NAME).date(UPDATED_DATE).file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
