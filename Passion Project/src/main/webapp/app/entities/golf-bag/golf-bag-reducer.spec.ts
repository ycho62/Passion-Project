...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './golf-bag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GOLFBAG_LIST actions', async () => {
    ...
    it('dispatches FETCH_GOLFBAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GOLFBAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GOLFBAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GOLFBAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GOLFBAG actions', async () => {
      const expectedActions = [
        {
