...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLUBSTATS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLUBSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLUBSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLUBSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLUBSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLUBSTATS actions', async () => {
      const expectedActions = [
        {
